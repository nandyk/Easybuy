...
public class Wholesaler extends Activity{
	 EditText username,pass;
	 int rslt;
	 String name,password;
	 public void onCreate(Bundle savedInstanceState) {
		  super.onCreate(savedInstanceState);
		  setContentView(R.layout.wholesaler);
	           ...
	           if(!(password.trim().equals(""))){
	               ...
	               @Override
	                   public void onSuccess(String response) {
	               	   ...
	               	   Toast.makeText(getApplicationContext(),"Clickedd",Toast.LENGTH_LONG).show();
	                       //prgDialog.hide();
	                       try {
	                           ...
	                           if(rslt == 1){
	                               ...
	                               Intent i = new Intent(Wholesaler.this,Content1.class);
